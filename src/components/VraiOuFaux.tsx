...
export default function VraiOuFaux() {
  const [affirmations] = useState<AffirmationVraiFaux[]>(INITIAL_AFFIRMATIONS);
          ...
          <div className="bg-white border border-stone-200 rounded-xl p-6 md:p-8 space-y-8 shadow-xs">
            ...
            <div id="vrai-faux-buttons-grid" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                ...
                className={`py-4 px-6 rounded-xl border text-base font-semibold flex items-center justify-center gap-3 transition-all ${
                  userChoice === null
          ...
          <div id="vrai-faux-controls" className="flex items-center justify-end">
            {userChoice !== null && (
              <button
                ...
                onClick={handleNext}
                className="px-5 py-2.5 rounded-lg bg-stone-900 text-white hover:bg-stone-800 text-sm font-medium transition-colors"
              >
