...
export default function VraiOuFauxTest() {
  const [affirmations] = useState<AffirmationVraiFaux[]>(STATEMENTS);
                  ...
                  className={`p-3.5 rounded-lg border text-sm sm:text-base font-semibold flex items-center justify-center gap-2 transition-all ${
                    userChoice === true
                      ? isSubmitted
                        ...
                        : 'border-stone-900 bg-stone-900 text-white ring-1 ring-stone-900 shadow-2xs'
      ...
      {!isSubmitted && (
        <div id="vrai-faux-test-submit-bar" className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-stone-200">
          ...
          <button
            ...
            className={`w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              isAllAnswered
